...
describe('upload.js', () => {
  ...
  describe('uploadSingleFile - 文件上传', () => {
    ...
    it('应上传大文件（多分块）', async () => {
      ...
      deployFile
        .mockResolvedValueOnce('https://chunk0.pages.dev/data')
        .mockResolvedValueOnce('https://chunk1.pages.dev/data')
        .mockResolvedValueOnce('https://chunk2.pages.dev/data');
      ...
      expect(deployFile).toHaveBeenCalledTimes(3);
    });
